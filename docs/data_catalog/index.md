...
|  [Bikeparking stands in Aarhus City](docs/data_catalog/metadata_datasets/nordic_citcom_gtm.md)  | Nordic | CitCom | GTM | *no specific value* | Ongoing | No | Aarhus Municipality | https://www.opendata.dk/city-of-aarhus/cykelparkering_aarhus |
|  [Bike terminals in Aarhus, air and tools](docs/data_catalog/metadata_datasets/nordic_citcom_gtm.md)  | Nordic | CitCom | GTM | *no specific value* | Ongoing | No | Aarhus Municipality | Cykelterminal - Datasæt |
|  [Citybike locations in Aarhus](docs/data_catalog/metadata_datasets/nordic_citcom_gtm.md)  | Nordic | CitCom | GTM | *no specific value* | *no specific value* | No | Aarhus Municipality | Aarhus Bycykel - Datasæt |
|  [Fast track bikeroutes in Aarhus](docs/data_catalog/metadata_datasets/nordic_citcom_gtm.md)  | Nordic | CitCom | GTM | *no specific value* | Ongoing | No | Aarhus Municipality | Supercykelsti i Aarhus Kommune - Datasæt |
|  [recreative bikeroutes in Aarhus](docs/data_catalog/metadata_datasets/nordic_citcom_gtm.md)  | Nordic | CitCom | GTM | *no specific value* | Ongoing | No | Aarhus Municipality | Rekreative cykelruter - Datasæt |
